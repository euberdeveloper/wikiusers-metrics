...
def retriever(month_activity: dict) -> float:
    try:
        return month_activity['avg_secs_since_same_day_event']
    except:
        return 0


if __name__ == '__main__':
    metricher = SurvivalMetricher(name='avg_secs_since_same_day_event_over_survived_months', dropoff_month_threshold=24, lang='ca', discriminator=active_discriminator, extractor=retriever)
    metricher.compute()
    metricher.save_json()
