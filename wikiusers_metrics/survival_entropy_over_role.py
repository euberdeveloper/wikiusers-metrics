...
if __name__ == '__main__':
    metricher = SurvivalMetricher(name='pages_entropy_on_role_over_survived_months', lang='de', dropoff_month_threshold=24, discriminator=active_discriminator, extractor=retrieve_page_entropy)
    metricher.compute()
    metricher.save_json()
