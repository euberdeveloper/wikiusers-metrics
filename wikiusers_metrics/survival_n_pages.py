...
def retrieve_n_pages(month_activity: dict) -> float:
    try:
        return month_activity['pages_activity']['n']
    except:
        return 0


if __name__ == '__main__':
    metricher = SurvivalMetricher(name='n_pages_over_survived_months', dropoff_month_threshold=24, lang='ca', discriminator=active_discriminator, extractor=retrieve_n_pages)
    metricher.compute()
    metricher.save_json()
